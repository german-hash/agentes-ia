...
tools = [
    {
        ...
        "description": "Busca noticias recientes del rubro QSR en internet",
        "input_schema": {
            "type": "object",
            "properties": {
                "query": {
                    "type": "string",
                    "description": "El término de búsqueda, ej: 'últimas noticias QSR 2026'"
                }
            },
            "required": ["query"]
        }
...
if __name__ == "__main__":
    ...
    ejecutar_agente(f"¿Cuáles son las noticias de QSR del día de hoy {hoy}?")