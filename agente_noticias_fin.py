...
tools = [
    {
        ...
        "input_schema": {
            ...
            "properties": {
                "query": {
                    "type": "string",
                    "description": "El término de búsqueda, ej: 'últimas noticias finanzas y global macro 2026'"
                }
            },
            "required": ["query"]
        }
...
if __name__ == "__main__":
    ...
    ejecutar_agente(f"¿Cuáles son las noticias de finanzas y global macro del día de hoy {hoy}?")